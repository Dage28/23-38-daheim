...
// SQL-Abfrage, um nur erledigte Aufgaben aus der Datenbank zu holen (WHERE 'status' = 1, nach wichtigkeit sortieren und dann nach date sortieren)
$sql = "SELECT * FROM `crud` WHERE `status` = 1 ORDER BY 
            CASE 
