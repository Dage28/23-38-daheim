...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `crud` SET `aufgabe`='$aufgabe', `datum`='$datum', `wichtigkeit`='$wichtigkeit' WHERE id = $id";
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                ...
                <div class="mb-3">
                    ...
                    <!-- Radio-Buttons zur Auswahl der Wichtigkeit -->
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="wichtigkeit" id="sehr_wichtig" value="sehr_wichtig" <?php echo ($row["wichtigkeit"] == 'sehr_wichtig') ? "checked" : ""; ?>>
                        <label for="sehr_wichtig" class="form-check-label">Sehr wichtig</label>
                    </div>
                    <div class="form-check">
